...
const MailBox = () => {
    ...
    const folders = [
        ...
        { lable: "Drafts", icon: <RiDraftLine />, contentData: "", contentBackground: "", onclick: [] },
        { lable: "Trash", icon: <FaRegTrashAlt />, contentData: deletedCount, contentBackground: "red", onclick: deletedataArray }
    ]
