...
const MailBox = () => {
    ...
    const folders = [
        ...
        { lable: "Send Mail", icon: <AiOutlineMail />, contentData: "", contentBackground: "", onclick: [] },
        ...
        <React.Fragment>
            ...
            >
                <IconButton
                    ...
                    onClick={() => history.push("/corporates/CallCenter/Setting")}
                />
                            ...
                            <Flex p={4} alignItems="flex-start" justifyContent="flex-start">
                                <VStack spacing={4}>
                                    <HStack spacing={12}>
                                        <HStack spacing={9}>
                                            <Box>
                                                <Text fontSize={32}>Inbox({inboxcount})</Text>
                                            </Box>
                                            <Spacer />
                            ...
                            emails && emails.map((e, i) => (
                                <Box width="100%" h={10} borderWidth={1} borderColor="lightgray">
                                    <HStack spacing={10} key={i}>
                                        <Box width="20%"> <Checkbox p={2} onChange={() => setDeleteData(e)}><Text ml={4} fontWeight="semibold" >{e.from}</Text></Checkbox></Box>
